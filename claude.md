...
| `executacao_alimentos_cumulado.docx` | Execução Cumulada (Prisão + Penhora) | Todos os campos combinados |
...
| {data_atual}                      | Data da petição                            |
| {defensoraNome}                   | Nome do(a) Defensor(a)                     |
| {#lista_filhos} / {/lista_filhos} | Tags de repetição (looping)                |
...
# ==========================================
# CONTEXTO INJETADO (ATUALIZAÇÃO CRÍTICA): SOURCE OF TRUTH DO BANCO DE DADOS - schema.prisma
