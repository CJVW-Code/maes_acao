                  ...
                  <div className="flex justify-between items-center bg-highlight/10 p-4 rounded-lg border border-highlight/20">
                    <div>
                      ...
                      <p className="text-sm text-muted">
                        Você pode gerenciar os casos existentes ou iniciar um novo para esta mesma
                        representante.
                      </p>
                    </div>
                    <button
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p>
                            <strong>Nome do Assistido:</strong> {caso.nome_assistido}
                          </p>
                          {caso.nome_representante && (
                            <p>
                              <strong>Nome da Representante:</strong> {caso.nome_representante}
                            </p>
                          )}
                          <p>
                            <strong>Status:</strong> <span className="badge">{caso.status}</span>
                          </p>
                          {caso.descricao && (
