...
export const StepDadosPessoais = React.memo(({
  assistidoEhIncapaz,
  assistidoNome,
  assistidoCpf,
  assistidoNascimento,
  ...
  representanteRg,
  representanteEmissorRg,
  requerenteEnderecoResidencial,
  requerenteEmail,
  requerenteTelefone,
  nomeMaeRepresentante,
  nomePaiRepresentante,
  outrosFilhos,
  dispatch,
  handleFieldChange,
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <label className="flex items-center gap-2 cursor-pointer p-3 bg-surface rounded-lg border border-soft hover:border-primary transition">
              <input
                ...
                value="nao"
                checked={assistidoEhIncapaz === "nao"}
            ...
            <label className="flex items-center gap-2 cursor-pointer bg-surface p-3 rounded-lg border border-soft hover:border-primary transition">
              <input
                ...
                name="assistidoEhIncapaz"
                value="sim"
                checked={assistidoEhIncapaz === "sim"}
                onChange={handleFieldChange}
                className="w-4 h-4 text-primary"
              />
